...
require __DIR__.'/clases/mascota.php';
...
$app->add(function ($req, $res, $next) {
    ...
    $app->get('/traerunamascota/[{id}]', function ($request, $response, $args) {
                                                
                                                
        $uno = Mascota::TraerUnaMascota($args['id']);
    ...
    $app->post('/altaMascota',function (Request $request, Response $response,$args) {
        ...
        try	
        {
                ...
                $resultado = Mascota::AltaMascota($ArrayDeParametros);
...
return $response->withJson($resultado);
                ...
                $app->post('/BajaMascota',function (Request $request, Response $response,$args) {
                                
                                $ArrayDeParametros = $request->getParsedBody();  

                                $resultado = Mascota::BajaMascota($ArrayDeParametros['id']);
...
//                return $response->withJson($rta);
        ...
        /*****************************   TRAER BD   *******************************/
                //Traer todos los helados
                        ...
                        $mascota = Mascota::TraerTodasLasMascotas();
                        return $response->withJson($mascota);
                        });
