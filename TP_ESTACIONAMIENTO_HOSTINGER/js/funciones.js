...
function FormIngVeh()
{
	...
	var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/formIngVeh",
		type:"post"
...
function FormSalidaVeh()
{
	...
	var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/FormSalidaVeh",
		type:"post"
		//data:{queHacer:"MostarLogin"}
	});
	funcionAjax.done(function(retorno){
...
function FormAltaEmp()
{
	...
	var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/formaltaemp",
		type:"post"
		//data:{queHacer:"MostarLogin"}
	});
	funcionAjax.done(function(retorno){
...
function GestionEmp()
{
	...
	var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/gestionemp",
		type:"post"
		//data:{queHacer:"MostarLogin"}
	});
	funcionAjax.done(function(retorno){
...
function MostarLogin()
{
	...
	var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/mostrarlogin",
		type:"post"
		//data:{queHacer:"MostarLogin"}
	});
	funcionAjax.done(function(retorno){
...
function validarLogin()
{
		...
		var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/validarusuario",
		type:"post",
		data:{
			recordarme:recordar,
			nombre:varUsuario,
...
{	
	var funcionAjax=$.ajax({
		url:"http://damianvogel.esy.es/desloguear",
		type:"post"		
	});
	funcionAjax.done(function(retorno){
			//MostarBotones();
